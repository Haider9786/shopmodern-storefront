...
export const NotificationDropdown = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-[calc(100vw-2rem)] sm:w-80 max-w-sm bg-white rounded-xl shadow-xl border border-gray-100 z-50 max-h-[70vh] sm:max-h-96 flex flex-col">
          <div className="p-3 sm:p-4 border-b border-gray-100 flex items-center justify-between gap-2 min-w-0">
            ...
            {unreadCount > 0 && (
              <button
                ...
                className="text-[11px] sm:text-xs text-brand-primary hover:text-brand-primary-hover font-medium shrink-0 whitespace-nowrap min-h-[36px] inline-flex items-center"
              >
                Mark all read
              </button>
            )}
          ...
          {notifications.length > 0 && (
            <div className="p-2.5 sm:p-3 border-t border-gray-100 text-center shrink-0">
              <button className="text-[11px] sm:text-xs text-gray-500 hover:text-gray-700 font-medium min-h-[36px] inline-flex items-center">
